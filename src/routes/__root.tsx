...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Hearth Handbook is a digital welcome mat for Wisconsin towns — meet the locals, grab a coupon, and feel at home." },
      ...
      { property: "og:description", content: "A digital welcome mat for Wisconsin towns — meet the locals, grab a coupon, and feel at home." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Hearth Handbook — Your local Wisconsin town guide" },
      { name: "twitter:description", content: "A digital welcome mat for Wisconsin towns — meet the locals, grab a coupon, and feel at home." },
    ],
    links: [
