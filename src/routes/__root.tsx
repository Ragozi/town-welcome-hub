...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/4z7voJYiy2bZKLpnCCJfGXmNZmx2/social-images/social-1778693333363-social1.webp" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/4z7voJYiy2bZKLpnCCJfGXmNZmx2/social-images/social-1778693333363-social1.webp" },
    ],
    links: [
