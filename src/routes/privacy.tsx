  ...
  head: () => ({
    meta: [
      { title: "Privacy Policy — Hearth Handbook" },
      {
        name: "description",
        content:
          "How Hearth Handbook collects, uses, and protects your personal data, location, and email preferences.",
      },
      { property: "og:title", content: "Privacy Policy — Hearth Handbook" },
      {
        property: "og:description",
        content: "How Hearth Handbook collects, uses, and protects your personal data.",
      },
...
function PrivacyPage() {
  return (
    <div className="mx-auto max-w-3xl px-5 py-16 prose prose-sm dark:prose-invert">
      ...
      <p>
        To personalize your local feed, show you relevant coupons, and (with your opt-in) send you
        emails about local deals, events, and new businesses.
      </p>
      ...
      <h2>Your rights</h2>
      <p>
        Realtors can update their profile, branding, and account from the dashboard. To delete your
        account or request data removal, email{" "}
        <a href="mailto:info@hearthhandbook.com" className="underline">
